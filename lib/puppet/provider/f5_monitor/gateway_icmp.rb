...
Puppet::Type.type(:f5_monitor).provide(:gateway_icmp, parent: Puppet::Provider::F5) do
  ...
  def self.instances
    instances = []
    monitors = Puppet::Provider::F5.call_items('/mgmt/tm/ltm/monitor/gateway-icmp')
  ...
  def create
    ...
    result = Puppet::Provider::F5.post("/mgmt/tm/ltm/monitor/gateway-icmp", message(resource))
