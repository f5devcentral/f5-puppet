...
describe Puppet::Type.type(:f5_monitor) do
...

  {
    ...
    'up_interval'                      => { pass: %w(disabled enabled true false), fail: %w(yes please magic present superenabled) },
    ...
    'manual_resume'                    => { pass: %w(yes no true false), fail: %w(disabled enabled please magic present superenabled) },
    'compatibility'                    => { pass: %w(disabled enabled true false), fail: %w(1 2 3 4 5 yes no) },
    'reverse'                          => { pass: %w(yes no true false), fail: %w(disabled enabled please magic present superenabled) },
    'transparent'                      => { pass: %w(yes no true false), fail: %w(disabled enabled please magic present superenabled) },
